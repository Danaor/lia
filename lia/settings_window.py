...
def _demo_state():
    ...
    return {
        ...
        "tables": {
            ...
            "summary": [{"model": "gpt-5.6-sol", "label": "ChatGPT 5.6-SOL (cloud)", "checked": True, "enabled": True, "note": ""},
                        {"model": "gemini-3.7-flash", "label": "Gemini 3.7 Flash (free)", "checked": False, "enabled": True, "note": ""},
                        {"model": "gemma4:31b-it-qat", "label": "Gemma 4 31B QAT (local)", "checked": False, "enabled": False, "note": "start Ollama"}],
