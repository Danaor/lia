    ...
    return {
        ...
        "tables": {
            "dictation": [{"idx": 0, "label": "Hebrew Turbo Local ⭐ (best local Hebrew)", "checked": True, "where": "local", "wnote": "GPU (4 GB+) recommended · slower on CPU"},
                          ...
                          {"idx": 7, "label": "Gemini 3.5 transcribe", "checked": False, "enabled": False, "where": "cloud", "wnote": "Requires API key · free tier available · ~3.6s/clip (slower than Groq) · Google may use free-tier audio to train its models"},
            ...
            "meeting": [{"key": "local_hebrew_turbo", "label": "Hebrew Turbo Local only", "checked": True, "enabled": True, "note": ""},
                        {"key": "gemini_transcribe", "label": "Gemini 3.5 transcribe", "checked": False, "enabled": False, "where": "cloud", "wnote": "Requires API key · free tier available · Google may use free-tier audio to train its models", "note": "needs gemini_api_key"},
