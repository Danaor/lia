    ...
    return {
        ...
        "tables": {
            "dictation": [{"idx": 0, "label": "Hebrew Turbo Local ⭐ (best local Hebrew)", "checked": True, "where": "local"},
                          ...
                          {"idx": 4, "label": "OpenAI gpt-transcribe ⭐ (best)", "checked": False, "where": "cloud", "wnote": "API key set"},
                          {"idx": 6, "label": "Groq Turbo", "checked": False, "enabled": False, "where": "cloud", "wnote": "Requires API key"},
            ...
            "summary": [{"model": "off", "label": "Off - transcript only (no AI summary)", "checked": True, "enabled": True, "note": ""},
                        {"model": "gpt-5.6-sol", "label": "ChatGPT 5.6-SOL (cloud)", "checked": False, "enabled": False, "where": "cloud", "wnote": "Requires API key", "note": ""},
                        {"model": "gemini-3.7-flash", "label": "Gemini 3.7 Flash (free)", "checked": False, "enabled": False, "where": "cloud", "wnote": "Requires API key", "note": "set Gemini key"},
            ...
            "cleanup_models": [{"provider": "gemini", "model": "gemini-3.5-flash-lite", "label": "Gemini 3.5 Flash-Lite (free, fastest)", "checked": False},
                               {"provider": "openai", "model": "gpt-5.6-luna", "label": "GPT-5.6 Luna - light, fast", "checked": True}],
